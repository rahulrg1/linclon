    ...
    <div className="mx-[5%] my-[2rem] rounded-lg bg-gradient-to-r from-violet-900 to-gray-900 dark:bg-gradient-to-r dark:from-black dark:to-gray-900">
      <div className="flex xs:flex-col md:flex-row dark:text-white mx-[2rem] pb-[5rem] gap-10 font-bold">
        ...
        <form className=" xs:mx-auto md:ml-[10%] md:mt-[15%] xs:min-w-[10rem] md:min-w-[25rem] text-lg shrink dark:text-neutral-400">
          <label>Name</label>
          <br/>
          <input placeholder="name" className=" text-black my-2 md:min-w-[100%] rounded-[.25rem] px-3" />
          <br/>
          <label>Bio</label>
          <br />
          <textarea className="text-black h-[10rem] md:min-w-[100%] my-2 rounded-[.25rem] px-3" />
          <br />
          <label>Skills</label>
          <br />
          <textarea className="text-black my-2 md:min-w-[100%] rounded-[.25rem] px-3" /> 
          <br/>
          <label>Occupation</label>
          <br />
          <input className="text-black my-2 md:min-w-[100%] rounded-[.25rem] px-3" />
          <br />
