    ...
    <div style={{backgroundImage:"conic-gradient(white, grey,white )"}} className="dark:bg-none mx-[5%] my-[2rem] rounded-lg">
      <div className="flex xs:flex-col md:flex-row dark:text-white mx-[2rem] pb-[5rem] gap-10 font-bold">
        <section className="flex flex-col items-end my-10 basis-[30%] shrink-0 xs:mx-auto md:mx-0" >
          ...
          <button type="submit" style={uploadShown?{}:{display:'none'}} onClick={ifUploadShown} className="my-4 mr-4 px-2 py-1 bg-blue-700 text-white rounded-full">Upload Profile Photo</button>
          <button type="submit" style={uploadShown?{display:'none'}:{}} onClick={ifUploadShown} className="my-4 mr-4 px-2 py-1 bg-blue-700 text-white rounded-full">Update Profile Photo</button>
        </section>  
